...
public class ApiInitDataListener implements ApplicationListener<ContextRefreshedEvent>, Ordered {
    ...
    public void addParagraph() {
        ...
        paragraph1.setContent("<ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\">\n" +
                "    <li>\n" +
                "        <p>\n" +
        ...
        paragraph2.setContent("<ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\">\n" +
                "    <li>\n" +
                "        <p>\n" +
        ...
        paragraph3.setContent("<ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\">\n" +
                "    <li>\n" +
                "        <p>\n" +
        ...
        paragraph4.setContent("<ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\">\n" +
                "    <li>\n" +
                "        <p>\n" +
                "            以上费用未提及包括的其他费用\n" +
                "        </p>\n" +
